...
const FetchData = ({ cat }) => {
    ...
    const fetchData = async () => {
        await axios
        .get(
            cat ? `https://newsapi.org/v2/top-headlines?country=in&category=${cat}&apiKey=9476b605c2844d628f8833c59ca5a4eb`
            :"https://newsapi.org/v2/top-headlines?country=in&apiKey=9476b605c2844d628f8833c59ca5a4eb"
        )
